...
#define Z_HOME_BUMP_MM 20 // deltas need the same for all three axes
...
//#define SLOWDOWN // (don't use SLOWDOWN with DELTA because DELTA generates hundreds of segments per second)
#if ENABLED(SLOWDOWN)
