...
#define STRING_CONFIG_H_AUTHOR "(Zonkie, Geeetech Delta Rostock G2S Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Rostock G2S Pro Y Hotend"
...
//#define ELECTROMAGNETIC_SWITCHING_TOOLHEAD
  ...
  #define SWITCHING_TOOLHEAD_Y_POS          200         // (mm) Y position of the toolhead dock
  #define SWITCHING_TOOLHEAD_Y_SECURITY      10         // (mm) Security distance Y axis
  #define SWITCHING_TOOLHEAD_Y_CLEAR         60         // (mm) Minimum distance from dock for unobstructed X axis
  #define SWITCHING_TOOLHEAD_X_POS          { 200, 0 }  // (mm) X positions for parking the extruders
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 199.5        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 201.9             // (mm) Get this value from G33 auto calibrate
